...
public class DockerClientImpl2 implements Closeable, DockerClient2 {
    private final DockerClientConfig dockerClientConfig;

    private DockerCmdExecFactory dockerCmdExecFactory;

    private DockerClientImpl2() {
        this(DefaultDockerClientConfig.createDefaultConfigBuilder().build());
    }

    private DockerClientImpl2(String serverUrl) {
        this(configWithServerUrl(serverUrl));
    }

    private DockerClientImpl2(DockerClientConfig dockerClientConfig) {
    ...
    public static DockerClientImpl2 getInstance() {
        return new DockerClientImpl2();
    }

    public static DockerClientImpl2 getInstance(DockerClientConfig dockerClientConfig) {
        return new DockerClientImpl2(dockerClientConfig);
    }

    public static DockerClientImpl2 getInstance(String serverUrl) {
        return new DockerClientImpl2(serverUrl);
    }

    public DockerClientImpl2 withDockerCmdExecFactory(DockerCmdExecFactory dockerCmdExecFactory) {
    ...
    @Override
    public EventsCmd2 eventsCmd() {
        return new EventsCmdImpl2(getDockerCmdExecFactory().createEventsCmdExec());
    }

    @Override
    public EventsCmd2 eventsCmd2() {
        return new EventsCmdImpl2(getDockerCmdExecFactory().createEventsCmdExec());
    }
